...
public class exampleTEster extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        scroller = new com.company.component.ScrollForTheReservationOfTIckets();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new exampleTEster().setVisible(true);
            }
        });
    }
    
    private com.company.component.ScrollForTheReservationOfTIckets scroller;
